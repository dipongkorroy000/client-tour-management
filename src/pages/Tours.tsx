  ...
  return (
    <div className="container mx-auto px-5 py-8 grid grid-cols-12 gap-5">
      ...
      <div className="col-span-9 w-full">
        {data?.map((item) => (
          <div key={item.slug} className="border border-muted rounded-lg shadow-md overflow-hidden mb-6 flex">
            ...
            <div className="p-6 flex-1">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                ...
                {item.amenities.length > 3 && (
                  <span className="px-2 py-1 bg-muted/50 text-muted-foreground text-xs rounded-full">+{item.amenities.length - 3} more</span>
                )}
              </div>
